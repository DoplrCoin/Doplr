Contributing to DOPLR Core
============================

The DOPLR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DOPLR Core project, and is not to be
confused with overall DOPLR Network Protocol consensus changes.

Whether a pull request is merged into DOPLR Core rests with the project merge
...
Patches that change DOPLR consensus rules are considerably more involved than
...
Where a patch set proposes to change the DOPLR consensus, it must have been
...
The project leader is the release manager for each DOPLR Core release.
