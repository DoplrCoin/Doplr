...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Doplr Core doplr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  doplr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded doplr transaction") + "\n" +
                               "  doplr-tx [options] -create [commands]   " + _("Create hex-encoded doplr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded doplr transaction
