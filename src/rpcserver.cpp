...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DOPLR features */
        {"doplr", "masternode", &masternode, true, true, false},
        {"doplr", "listmasternodes", &listmasternodes, true, true, false},
        {"doplr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"doplr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"doplr", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"doplr", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"doplr", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"doplr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"doplr", "masternodedebug", &masternodedebug, true, true, false},
        {"doplr", "startmasternode", &startmasternode, true, true, false},
        {"doplr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"doplr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"doplr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"doplr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"doplr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"doplr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"doplr", "mnbudget", &mnbudget, true, true, false},
        {"doplr", "preparebudget", &preparebudget, true, true, false},
        {"doplr", "submitbudget", &submitbudget, true, true, false},
        {"doplr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"doplr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"doplr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"doplr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"doplr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"doplr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"doplr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"doplr", "checkbudgets", &checkbudgets, true, true, false},
        {"doplr", "mnsync", &mnsync, true, true, false},
        {"doplr", "spork", &spork, true, true, false},
        {"doplr", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> doplr-cli " + methodname + " " + args + "\n";
}
