...
/* Doplr GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DOPLR"
#define QAPP_ORG_DOMAIN "doplr.org"
#define QAPP_APP_NAME_DEFAULT "DOPLR-Qt"
#define QAPP_APP_NAME_TESTNET "DOPLR-Qt-testnet"
