                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DOPLR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DOPLR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and doplr: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DOPLR Core"), this);
    aboutAction->setStatusTip(tr("Show information about DOPLR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DOPLR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DOPLR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DOPLR addresses"));
    ...
    openAction->setStatusTip(tr("Open a DOPLR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DOPLR Core help message to get a list with possible DOPLR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DOPLR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DOPLR network", "", count));
}
...
{
    QString strTitle = tr("DOPLR Core"); // default title
