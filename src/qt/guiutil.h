...
/** Utility functions used by the DOPLR Qt UI.
 */
namespace GUIUtil
{
...
// Render DOPLR addresses in monospace font
...
// Parse "doplr:" URI into recipient object, return true on successful parsing
