...
QT_TRANSLATE_NOOP("pivx-core", "Copyright (C) 2015-%i The DOPLR Core Developers"),
...
QT_TRANSLATE_NOOP("pivx-core", "Error loading wallet.dat: Wallet requires newer version of DOPLR Core"),
...
QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. DOPLR Core is shutting down."),
...
QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart DOPLR Core to complete"),
