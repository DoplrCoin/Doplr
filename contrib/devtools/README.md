...
DOPLR-Project/DOPLR repository.
...
Setup
---------
Configuring the github-merge tool for the DOPLR repository is done in the following way:

    git config githubmerge.repository DOPLR-Project/DOPLR
...
A script to optimize png files in the DOPLR
