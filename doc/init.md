...
All three startup configurations assume the existence of a "doplr" user
...
Once you have a password in hand, set rpcpassword= in /etc/doplr/doplr.conf

For an example configuration file that describes the configuration settings,
see contrib/debian/examples/doplr.conf.
...
Configuration file:  /etc/doplr/doplr.conf
...
should all be owned by the doplr user and group.  It is advised for security
reasons to make the configuration file and data directory only readable by the
doplr user and group.  Access to doplr-cli and other pivxd rpc clients
