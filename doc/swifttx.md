...
This mechanism has been integrated into Bitcore-Node-DOPLR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DOPLR-Project/insight-api-doplr#web-socket-api](https://github.com/DOPLR-Project/insight-api-doplr#web-socket-api) 
* API: [https://github.com/DOPLR-Project/insight-api-doplr#swifttx-transactions](https://github.com/DOPLR-Project/insight-api-doplr#swifttx-transactions) 
...
By default, the DOPLR Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DOPLR Core daemon:
