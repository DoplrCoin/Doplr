TOR SUPPORT IN DOPLR
=======================

It is possible to run DOPLR as a Tor hidden service, and connect to such services.
...
Run DOPLR behind a Tor proxy
----------------------------------

The first step is running DOPLR behind a Tor proxy. This will already make all
...
```
-externalip=X   You can tell doplr about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/doplr-service/hostname. Onion addresses are given
...
List of known DOPLR Tor relays
------------------------------------
```
