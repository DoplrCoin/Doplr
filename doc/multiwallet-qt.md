...
In order to support loading of multiple wallets in doplr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is doplr.cpp.
...
Changes to doplr.cpp
----------------------
doplr.cpp is the entry point into doplr-qt, and as such, will require some minor modifications to provide hooks for
