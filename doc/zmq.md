...
The DOPLR Core daemon can be configured to act as a trusted "border
router", implementing the doplr wire protocol and relay, making
...
The ZeroMQ feature in DOPLR Core requires ZeroMQ API version 4.x or
...
These options can also be provided in doplr.conf.
